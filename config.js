...
export const config = {
    ...
    api_top_rated_movies_2000: "&language=en-US&sort_by=vote_average.desc&include_adult=false&include_video=false&page=1&primary_release_date.gte=2000-01-01&vote_count.gte=500&with_watch_monetization_types=flatrate"
}
